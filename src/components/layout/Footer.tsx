      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600 max-w-md">
              Your AI-powered assistant for making smarter marketing product purchases. Track, analyze, and get personalized recommendations.
            </p>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-base text-gray-400">
            &copy; {currentYear} MarketingBuyer AI. All rights reserved.
          </p>
